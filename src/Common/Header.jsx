...
const Header = () => {
    ...
    return (
        <>
            <TopHeader />
            <header className={`page_header header_white toggler_xs_right columns_margin_0 ${menuOpen ? "mobile-active" : ""}`}>
                <Container>
                    <Row>
                        <Col sm={12} className="display_table">
                            ...
                            <div className="header_mainmenu display_table_cell text-center m-auto">
                                <nav className={`mainmenu_wrapper text-center mobile-menu d-flex justify-content-center ${menuOpen ? "mobile-active" : ""}`}>
                                ...
                                {/* Toggle button */}
                                <span className={`toggle_menu ${menuOpen ? "mobile-active" : ""}`} onClick={toggleMenu}>
                                    <span />
                                </span>
                            </div>
